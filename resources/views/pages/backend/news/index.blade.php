                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <p class="card-text">News website at eti</p>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($news as $news)
                                        <tr>
                                            ...
                                            <td>{{ $news->name }}</td>
                                            <td>
                                                <a href="{{ asset('frontend/img/news/' . $news->id . '/' . $news->image) }}"
                                                    target="_blank">
                                                    <img src="{{ asset('frontend/img/news/' . $news->id . '/' . $news->image) }}"
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('news.editImage', $news->id) }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    id="delete_confirm{{ $news->id }}" data-id="{{ $news->id }}">
                                                    Delete</button>
