                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('productCategoryGallery.update', $gallery->id) }}" method="POST"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama" id="nama" value="{{ $gallery->nama }}"
                                            placeholder="Nama" />
                                ...
                                <div class="form-actions text-right">
                                    <a href="{{ route('productType.index', $gallery->category_id) }}"
