    ...
    <div class="animsition">
        ...
        <div class="section padding-bottom over-hide background-dark-2">
            ...
            <div id="projects-grid">
                <a href="{{ route('productsDetail') }}" class="cursor-link animsition-link tipped"
                    data-title="Soldier <span><em>supplies</em></span>"
                ...
                <a href="{{ route('productsDetail') }}" class="cursor-link animsition-link tipped"
                    data-title="technology <span><em>information</em></span>"
                    data-tipper-options='{"direction":"top","follow":"true","margin":30}'>
                ...
                <a href="{{ route('productsDetail') }}" class="cursor-link animsition-link tipped"
                    data-title="modified <span><em>vehicles</em></span>"
                    data-tipper-options='{"direction":"top","follow":"true","margin":30}'>
