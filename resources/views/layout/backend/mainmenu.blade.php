            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="material-icons">explore</i><span class="menu-title" data-i18n="Components">Product & Services</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="component-alerts.html"><i class="material-icons"></i><span data-i18n="Alerts">Defense</span></a>
                        </li>
                        <li><a class="menu-item" href="component-callout.html"><i class="material-icons"></i><span data-i18n="Callout">Commercial</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="{{ route('user.index') }}"><i class="material-icons">person</i><span class="menu-title" data-i18n="User">User</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">supervisor_account</i><span class="menu-title" data-i18n="User">Role</span></a>
                </li>
