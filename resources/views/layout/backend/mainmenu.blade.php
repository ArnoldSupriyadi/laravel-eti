<div class="main-menu material-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="crypto-transactions.html"><i class="material-icons">format_list_bulleted</i><span class="menu-title" data-i18n="Transactions">Transactions</span></a>
                </li>
                <li class=" nav-item"><a href="crypto-currency-exchange.html"><i class="material-icons">local_atm</i><span class="menu-title" data-i18n="Currency Exchange">Currency Exchange</span></a>
                </li>
                <li class=" nav-item"><a href="crypto-trading.html"><i class="material-icons">attach_money</i><span class="menu-title" data-i18n="Trading">Trading</span></a>
                </li>
                <li class=" nav-item"><a href="crypto-wallet.html"><i class="material-icons">payment</i><span class="menu-title" data-i18n="Wallet">Wallet</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('user.index') }}"><i class="material-icons">history</i><span class="menu-title" data-i18n="User">User</span></a>
                </li>
